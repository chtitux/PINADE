...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'myedt_id'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Myedt'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'myedt_id'         => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Myedt'), 'column' => 'id')),
